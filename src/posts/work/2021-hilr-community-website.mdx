---
published: true
categories: Design Research, Experience Design, Design Engineering
...
## Problem and Context
Harvard Institute for Learning in Retirement (HILR) offers learning opportunities for retirees. 
...
#### Concerned that “Resources” did not provide enough context, I suggested that we did an A/B tree test with a navigational structure that spread resource articles across the site. 
...
![Results from the A/B tree test showing that the trees had similar overall scores](../../images/work/2021-hilr/trees-2.png)
...
To ease the design process, I repurposed the visual theme of another website my team had created by copying and adjusting the CSS as needed. 
...
However, I changed the site’s primary color from Harvard crimson to  Harvard blue-bonnet to create a more welcoming community feel. 
...
![The new website on phones and tablets](../../images/work/2021-hilr/mobile.png)
...
The Beyond the Classroom page was meant to encompass all extracurricular opportunities available to HILR members. 
