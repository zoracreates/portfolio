...
featuredImage: ../../images/work/2019-c4aa/project-card-3.png
...
![Post meta-data mock up and final result](../../images/work/2019-c4aa/design-engineering.png)
...
![GitHub ticket showing a photo of C4AA print materials](../../images/work/2019-c4aa/headings-css.png)
![CSS code for clip-path headings](../../images/work/2019-c4aa/clip-path-assigment.png)
...
![JavaScript code for clip-path effect](../../images/work/2019-c4aa/clip-path-functions.png)

![C4AA clip-path effects applied to the website's headings and primary buttons](../../images/work/2019-c4aa/clip-path-example.png)
![C4AA clip-path effects applied to the website's headings, secondary buttons, and pull quotes](../../images/work/2019-c4aa/clip-path-example-2.png)
...
![GitHub comment describing the issue with using global selectors instead of class selectors](../../images/work/2019-c4aa/original-function-issue.png)
...
![JavaScript for creating custom WordPress blocks](../../images/work/2019-c4aa/editor-js.png)
...
![Custom WordPress blocks for clip-path buttons and headings](../../images/work/2019-c4aa/custom-blocks.png)
![GitHub pull request showing how instead of selecting all headings, the clip-path function selects only elemenets with a specific class](../../images/work/2019-c4aa/element-to-class.png)
...
![Custom block thumbnails look the same as the standard WordPress blocks](../../images/work/2019-c4aa/no-difference-in-blocks.png)
...
![Custom headings and buttons in the WordPress editor have different colors and shapes than standard headings and buttons](../../images/work/2019-c4aa/clip-path-on-editor.png)
