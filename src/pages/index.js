        ...
        <div className={`hero-band`}>
          <WrapperLg>
            ...
            <p className={`hero-text wrapper-md`}>
              ...
              I create and improve digital products and experiences. <a href="https://hwp.harvard.edu/people/zoraida-cabrera-mieles" target="_blank" rel="noopener noreferrer">I work at Harvard University</a>.
